...
import { CLANS_EN, type ClanTranslation } from '../content/clans.en'
import { CLANS_CA } from '../content/clans.ca'
import { CLAN_ICONS, THIN_BLOOD_ICON, THIN_BLOOD_NAMES } from '../icons/clans'
...
const OVERLAYS = { en: CLANS_EN, ca: CLANS_CA }
...
const clans = computed<Clan[]>(() =>
  resolvedLang.value === 'es'
    ? CLANS_DATA.clans
    : applyOverlay(CLANS_DATA.clans, OVERLAYS[resolvedLang.value]),
)
